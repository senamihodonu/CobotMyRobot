...
public:
  ...
  {}
  ::action_interfaces::action::SetAngle_Goal angles(::action_interfaces::action::SetAngle_Goal::_angles_type arg)
  {
...
class Init_SetAngle_Result_result
{
public:
  Init_SetAngle_Result_result()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::action_interfaces::action::SetAngle_Result result(::action_interfaces::action::SetAngle_Result::_result_type arg)
  {
...
{
  return action_interfaces::action::builder::Init_SetAngle_Result_result();
}

...
static rosidl_typesupport_introspection_c__MessageMember action_interfaces__action__SetAngle_Goal__rosidl_typesupport_introspection_c__SetAngle_Goal_message_member_array[2] = {
  {
    "angles",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_interfaces__action__SetAngle_Goal, speed),  // bytes offset in struct
    NULL,  // default value
...
size_t action_interfaces__action__SetAngle_Result__rosidl_typesupport_introspection_c__size_function__SetAngle_Result__end_angles(
  const void * untyped_member)
{
  (void)untyped_member;
  return 6;
...
const void * action_interfaces__action__SetAngle_Result__rosidl_typesupport_introspection_c__get_const_function__SetAngle_Result__end_angles(
  const void * untyped_member, size_t index)
{
  const double * member =
    (const double *)(untyped_member);
...
void * action_interfaces__action__SetAngle_Result__rosidl_typesupport_introspection_c__get_function__SetAngle_Result__end_angles(
  void * untyped_member, size_t index)
{
  double * member =
    (double *)(untyped_member);
...
void action_interfaces__action__SetAngle_Result__rosidl_typesupport_introspection_c__fetch_function__SetAngle_Result__end_angles(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const double * item =
    ((const double *)
    action_interfaces__action__SetAngle_Result__rosidl_typesupport_introspection_c__get_const_function__SetAngle_Result__end_angles(untyped_member, index));
  double * value =
    (double *)(untyped_value);
  *value = *item;
}

void action_interfaces__action__SetAngle_Result__rosidl_typesupport_introspection_c__assign_function__SetAngle_Result__end_angles(
  void * untyped_member, size_t index, const void * untyped_value)
{
  double * item =
    ((double *)
    action_interfaces__action__SetAngle_Result__rosidl_typesupport_introspection_c__get_function__SetAngle_Result__end_angles(untyped_member, index));
  const double * value =
    (const double *)(untyped_value);
  *item = *value;
}
...
static rosidl_typesupport_introspection_c__MessageMember action_interfaces__action__SetAngle_Result__rosidl_typesupport_introspection_c__SetAngle_Result_message_member_array[1] = {
  {
    ...
    6,  // array size
    false,  // is upper bound
    offsetof(action_interfaces__action__SetAngle_Result, end_angles),  // bytes offset in struct
    NULL,  // default value
    action_interfaces__action__SetAngle_Result__rosidl_typesupport_introspection_c__size_function__SetAngle_Result__end_angles,  // size() function pointer
    action_interfaces__action__SetAngle_Result__rosidl_typesupport_introspection_c__get_const_function__SetAngle_Result__end_angles,  // get_const(index) function pointer
    action_interfaces__action__SetAngle_Result__rosidl_typesupport_introspection_c__get_function__SetAngle_Result__end_angles,  // get(index) function pointer
    action_interfaces__action__SetAngle_Result__rosidl_typesupport_introspection_c__fetch_function__SetAngle_Result__end_angles,  // fetch(index, &value) function pointer
    action_interfaces__action__SetAngle_Result__rosidl_typesupport_introspection_c__assign_function__SetAngle_Result__end_angles,  // assign(index, value) function pointer
    NULL  // resize(index) function pointer
  }
};

...
bool action_interfaces__action__set_angle__goal__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // angles
    ...
    }
    {
      ...
      Py_ssize_t size = 6;
      double * dest = ros_message->angles;
...
PyObject * action_interfaces__action__set_angle__goal__convert_to_py(void * raw_ros_message)
{
  ...
  {  // angles
    ...
    double * src = &(ros_message->angles[0]);
...
bool action_interfaces__action__set_angle__result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // end_angles
    PyObject * field = PyObject_GetAttrString(_pymsg, "end_angles");
    if (!field) {
      return false;
    }
    {
      ...
      assert(PyArray_TYPE(seq_field) == NPY_FLOAT64);
      Py_ssize_t size = 6;
      double * dest = ros_message->end_angles;
      for (Py_ssize_t i = 0; i < size; ++i) {
        double tmp = *(npy_float64 *)PyArray_GETPTR1(seq_field, i);
        memcpy(&dest[i], &tmp, sizeof(double));
      }
...
PyObject * action_interfaces__action__set_angle__result__convert_to_py(void * raw_ros_message)
{
  ...
  {  // end_angles
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "end_angles");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    assert(sizeof(npy_float64) == sizeof(double));
    npy_float64 * dst = (npy_float64 *)PyArray_GETPTR1(seq_field, 0);
    double * src = &(ros_message->end_angles[0]);
    memcpy(dst, src, 6 * sizeof(double));
    Py_DECREF(field);
  }

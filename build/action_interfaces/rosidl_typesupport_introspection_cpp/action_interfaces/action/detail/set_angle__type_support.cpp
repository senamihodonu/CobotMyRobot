...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetAngle_Goal_message_member_array[2] = {
  {
    "angles",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(action_interfaces::action::SetAngle_Goal, speed),  // bytes offset in struct
    nullptr,  // default value
...
size_t size_function__SetAngle_Result__end_angles(const void * untyped_member)
{
  (void)untyped_member;
  return 6;
}

const void * get_const_function__SetAngle_Result__end_angles(const void * untyped_member, size_t index)
{
  const auto & member =
    *reinterpret_cast<const std::array<double, 6> *>(untyped_member);
  return &member[index];
...
void * get_function__SetAngle_Result__end_angles(void * untyped_member, size_t index)
{
  auto & member =
    *reinterpret_cast<std::array<double, 6> *>(untyped_member);
  return &member[index];
...
void fetch_function__SetAngle_Result__end_angles(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__SetAngle_Result__end_angles(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__SetAngle_Result__end_angles(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__SetAngle_Result__end_angles(untyped_member, index));
  const auto & value = *reinterpret_cast<const double *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetAngle_Result_message_member_array[1] = {
  {
    ...
    6,  // array size
    false,  // is upper bound
    offsetof(action_interfaces::action::SetAngle_Result, end_angles),  // bytes offset in struct
    nullptr,  // default value
    size_function__SetAngle_Result__end_angles,  // size() function pointer
    get_const_function__SetAngle_Result__end_angles,  // get_const(index) function pointer
    get_function__SetAngle_Result__end_angles,  // get(index) function pointer
    fetch_function__SetAngle_Result__end_angles,  // fetch(index, &value) function pointer
    assign_function__SetAngle_Result__end_angles,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  }
};
